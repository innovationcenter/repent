...
# into SANTA rules.  Take stdin or a filename.  Uses the function
# "santa_print" to emit SANTA rules.
#
...
#
# default value for santa_print(); everything we report is "available"
$status = "a";
