...
<IMG SRC=$HTML_ROOT/images/santa.gif>
<H1>SANTA Configuration Management</H1>
<HR>

<FORM METHOD=POST ACTION=santa_cf_action.pl>

<H2>Scanning levels and timeouts</H2>

<STRONG>What directory should I store the data in?</STRONG>
<DL compact>
<DT><DD><INPUT SIZE=25 NAME=santa_data VALUE=$santa_data>
...
You are running SANTA from a possibly trusted host
<DT><DD><INPUT TYPE="radio" NAME=untrusted_host VALUE=1 $cf_untrusted[1]>
You are running SANTA from an untrusted host
</DL>
