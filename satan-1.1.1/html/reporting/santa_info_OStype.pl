...
<BODY>
<H1><IMG SRC=$HTML_ROOT/images/santa.gif> Host Table - $_type Systems </H1>
<hr>
...
<H4> Sort hosts by:
<a href="santa_info_OStype.pl,$_TYPE,name,">name</a> |
<a href="santa_info_OStype.pl,$_TYPE,domain,">domain</a> |
<a href="santa_info_OStype.pl,$_TYPE,subnet,">subnet</a> |
<a href="santa_info_OStype.pl,$_TYPE,severity,">problem count</a> |
<a href="santa_info_OStype.pl,$_TYPE,severity_type,">problem type</a>
</H4>
