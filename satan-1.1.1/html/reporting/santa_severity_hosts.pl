...
<BODY>
<H1><IMG SRC=$HTML_ROOT/images/santa.gif> Host Table - $_severity </H1>
<hr>
...
<H4> Sort hosts by:
<a href="santa_severity_hosts.pl,$_SEVERITY,name,">name</a> |
<a href="santa_severity_hosts.pl,$_SEVERITY,domain,">domain</a> |
<a href="santa_severity_hosts.pl,$_SEVERITY,type,">system type</a> |
<a href="santa_severity_hosts.pl,$_SEVERITY,subnet,">subnet</a> |
<a href="santa_severity_hosts.pl,$_SEVERITY,severity,">problem count</a> 
</H4>
EOF
