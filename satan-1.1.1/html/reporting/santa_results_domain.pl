...
<BODY>
<H1><IMG SRC=$HTML_ROOT/images/santa.gif> Host Table - Domain $_domain</h1>
<hr>
...
<H4> Sort hosts by:
<A HREF="santa_results_domain.pl,$_domain,name,">name</a> |
<A HREF="santa_results_domain.pl,$_domain,type,">system type</a> |
<A HREF="santa_results_domain.pl,$_domain,subnet,">subnet</a> |
<A HREF="santa_results_domain.pl,$_domain,severity,">problem count</a> |
<A HREF="santa_results_domain.pl,$_domain,severity_type,">problem type</a>
</H4>
EOF
