...
<BODY>
<H1><IMG SRC=$HTML_ROOT/images/santa.gif> Host Table - $_service Servers </H1>
<hr>
...
<H4> Sort hosts by:
<a href="santa_info_servers.pl,$_SERVICE,name,">name</a> |
<a href="santa_info_servers.pl,$_SERVICE,domain,">domain</a> |
<a href="santa_info_servers.pl,$_SERVICE,type,">system type</a> |
<a href="santa_info_servers.pl,$_SERVICE,subnet,">subnet</a> |
<a href="santa_info_servers.pl,$_SERVICE,severity,">problem count</a> |
<a href="santa_info_servers.pl,$_SERVICE,severity_type,">problem type</a>
</H4>
EOF
