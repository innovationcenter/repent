...
<BODY>
<H1><IMG SRC=$HTML_ROOT/images/santa.gif> Host Tables - by System Type </H1>
<hr>
...
for (sort keys %systypes_by_class) {
	...
	<a href="santa_info_OSclass.pl,$_class,"> $_</a>
...
if (sizeof(*hosttype) > 0) {
	...
	print CLIENT <<EOF;
	<dt><IMG SRC=$HTML_ROOT/dots/$_dot.gif ALT="$_alt">
	<a href="santa_info_OSclass.pl,other,"> Other/unknown</a>
