...
<BODY>
<H1><IMG SRC=$HTML_ROOT/images/santa.gif> Host Table - Subnet $_subnet</h1>
<hr>
...
<H4> Sort hosts by:
<A HREF="santa_results_subnet.pl,$_subnet,name,">name</a> |
<A HREF="santa_results_subnet.pl,$_subnet,domain,">domain</a> |
<A HREF="santa_results_subnet.pl,$_subnet,type,">system type</a> |
<A HREF="santa_results_subnet.pl,$_subnet,severity,">problem count</a> |
<A HREF="santa_results_subnet.pl,$_subnet,severity_type,">problem type</a>
</H4>
EOF
