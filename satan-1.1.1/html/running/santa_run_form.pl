...
<HTML>
<HEAD>
<TITLE>SANTA target selection</TITLE>
<LINK REV="made" HREF="mailto:santa\@fish.com">
</HEAD>
<BODY>

<H1><IMG SRC=$HTML_ROOT/images/santa.gif> SANTA target selection</H1>

<hr>

<FORM METHOD=POST ACTION="santa_run_action.pl">
...
Should SANTA do a light scan, a normal scan, or should it hit the
