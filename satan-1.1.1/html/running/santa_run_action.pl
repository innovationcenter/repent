...
<BODY>
<H1><IMG SRC=$HTML_ROOT/images/santa.gif> Error - Unknown host</H1>
<hr>
...
<HTML>
<HEAD>
<TITLE>SANTA data collection </TITLE>
<LINK REV="made" HREF="mailto:santa\@fish.com">
</HEAD>
<BODY>
<H1><IMG SRC=$HTML_ROOT/images/santa.gif> SANTA data collection</H1>
<hr>
...
if (&getfqdn($tmp_target)) {
	print CLIENT <<EOF;
| <a href="../reporting/santa_info_host.pl,$tmp_target,">
